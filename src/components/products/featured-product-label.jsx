    ...
    return (
      <div
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-lg font-sans font-bold italic opacity-60">
            {product.vendor}
          </p>
        </div>
        <div className="max-w-md">
          <p className="text-sm font-sans font-medium leading-relaxed opacity-80">{product.description}</p>
        </div>
  ...
  return (
    <div
      ...
      <div className="leading-tight pr-4">
        ...
        <p className="text-sm font-sans font-bold italic opacity-60 mb-2">
          {product.vendor}
        </p>
