    ...
    if (mode === 'mock') {
      return (
        <div className='mt-20 flex w-full flex-col items-center justify-center overflow-hidden'>
          ...
          <p className='mt-2 text-center text-sm text-muted-foreground'>Complete the SFCC setup.</p>
        </div>
      );
    }
            ...
            <Link
              ...
              <div className='flex flex-row gap-6 p-4'>
                ...
                <div className='flex flex-col gap-2 2xl:gap-3 flex-1 justify-center'>
                  <span className='text-2xl font-serif font-black text-primary'>Bag is empty</span>
            ...
            <motion.div
              ...
              <div className='flex flex-col bg-white/80 backdrop-blur-3xl rounded-[40px] border border-white/40 shadow-2xl w-full h-full overflow-hidden'>
                ...
                <div className='flex items-center justify-between p-8 md:p-10 border-b border-primary/5 bg-white/40 backdrop-blur-md relative z-20'>
                  <h2 className='text-4xl font-serif font-black tracking-tighter text-primary'>
                    Your Bag
                  </h2>
                  <Button
                    size='sm'
                ...
                <div className='flex-1 overflow-hidden p-8 md:p-10 pt-6'>{renderCartContent()}</div>
              </div>
            </motion.div>
          </>
        )}
